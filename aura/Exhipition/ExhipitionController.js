 ...
 * 1.0   22-12-2025   ChangeMeIn@UserSettingsUnder.SFDoc   Initial Version
**/
({
...
AddSB : function(component, event, helper) {
    ...
    onChangeInsuranceBy: function(component, event, helper) {
       console.log('689 ');
        var Insurance_By1 = component.get("v.InsuranceBy1");
      console.log('691 Insurance_By__c :'+Insurance_By1);
        var LType = Insurance_By1=='BVC'?'All Risk Liability':'None';
       component.set("v.Liability_Type",LType);
        
    },
    
 //onChangeShipmentType : function(component, event, helper) {
  //  var shipmentType = event.getSource().get("v.value");
  //  console.log('Shipment Type : ' + shipmentType);

  //  component.set("v.ShipmentType", shipmentType);
//},
...
onChangeShipmentType : function(component, event, helper) {
    ...
    component.set("v.SelHub1", null);

    
    component.set(
        "v.showExhibitionAddress",
        shipmentType === 'To Exhibition'
    );

    // Disable consignee only for To Exhibition
    component.set(
        "v.disableConsignee",
        shipmentType === 'To Exhibition'
    );
    ...
    doInit : function(component, event, helper) {   
        component.set("v.showExhibitionAddress", false); // FROM Exhibition (default)
        component.set("v.disableConsignee", false); 
        ...
        action.setCallback(this,function(resp){
            ...
            {                
                ...
                component.set("v.pickupId",r.Id);
                 ...
                 if (r.Shipper_Name__c && r.Shipper_Name__r) {
    component.set("v.SelHub", {
        val: r.Shipper_Name__c,
        text: r.Shipper_Name__r.Name,
        objName: 'Account'
    });
