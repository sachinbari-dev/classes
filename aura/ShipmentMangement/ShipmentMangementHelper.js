({
    ...
    saveShipment : function(component,event,helper) {
        ...
        var shipment = component.get('v.Shipment');
    ...
    /*    if(showLiability_Type==true&& InsuranceBy1=='BVC' && Liability_Type=='')
        ...
        // --------------------------
        if(BVCServices1=='None')
        {
           window.alert('Choose BVC Service'); 
        }        
        // if(BVCServices1!='None' && ProdcutDescription1!='None'){
        if(stopSaving!=true && BVCServices1!='None' && customerGrossWeight>=0){
            //component.set("v.spinner",'true');
            var action = component.get('c.createShipmentRecord');            
            action.setParams({
                ...
                sNoteNumber:shippingNoteNumberManualValue,
                CS_ACCID : CS_ACCID,
            ...
            action.setCallback(this,function(resp){
                ...
                {      
                    ...
                    console.log('Test 1 RES :'+resp.getReturnValue());
                    if(resp.getReturnValue() == null)
                    {
                        var toastEvent = $A.get("e.force:showToast");
                        toastEvent.setParams({
                            title : 'Error',
                            message:'Enter a valid or available Shipping Note Number only.',
                            duration:' 5000',
                            key: 'info_alt',
                            type: 'error',
                            mode: 'pester'
                    ...
                    { 
                        ...
                        component.set("v.c_cpc",r.Customer_Product_Category__c); // added by imran on 18-03-2024
            ...
            toastEvent.setParams({
                title : 'Error',
                message:'BVC Service And Product Description Is Mandatory.',
                type: 'error'
