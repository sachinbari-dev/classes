({
	itemSelected : function(component, event, helper) {
        ...
        if(SelIndex){
            ...
            console.log('8 selItem :'+JSON.stringify(selItem));
            if(selItem.val){
    ...
    onFocusServerCall : function(component, event, helper) {
        ...
        var originval='';
        var ShipAcId = component.get("v.ShipAcId");
        var Text1=component.get("v.field_API_text1");
        var CustAcId = component.get("v.CustAcId");
        var isParent = component.get("v.isParent");
        var exhibition = component.get("v.Exhibition");
        console.log("11.isParent: ",isParent);
        console.log("11.origin: ",origin);
        console.log("11.CustAcId: ",CustAcId);
        if(origin !==null){
        ...
        console.log('55.searchText '+searchText);
        action.setParams({
            isParent:isParent,
            CustAcId : CustAcId,
    ...
    handleResponse : function (res,component,helper){
        if (res.getState() === 'SUCCESS') {
            ...
            console.log('22.RES :'+JSON.stringify(retObj));
            var R = JSON.stringify(retObj);            
            if(retObj.length <= 0){
